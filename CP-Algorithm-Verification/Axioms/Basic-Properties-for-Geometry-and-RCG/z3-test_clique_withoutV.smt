...
(assert (! (forall ((u point) (v point) (w point) (x point)) (=> (and (E u v) (E v w) (E w u) (inside u v w x )) (E u x))) :named C1))
...
(assert (! (forall ((u point) (v point) (w point)) (=> (and (left u v w) (left v u w)) (not (F u v)))) :named F4))
...
(assert (! (forall ((u point) (v point) (w point)) (=> (and ( left u v w) ( left v u w)) (colinear u v w))) :named X1))
(assert (! (forall ((u point) (v point) (w point)) (=> ( colinear u v w) (left u v w))) :named X2))
(assert (! (forall ((u point) (v point) (w point)) (=> ( colinear u v w) (left v u w))) :named X3))
