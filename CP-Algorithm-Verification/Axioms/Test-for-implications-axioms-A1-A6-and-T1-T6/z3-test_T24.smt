...
(assert (! (inside a b c e) :named Q1))
(assert (! (inside a b c d) :named Q2))
(assert (! (not (inside a b d e)) :named Q3))
(assert (! (not (inside b c d e)) :named Q4))
(assert (! (not (inside c a d e)) :named Q5))
(assert (! (not (= d e)) :named Q6))
