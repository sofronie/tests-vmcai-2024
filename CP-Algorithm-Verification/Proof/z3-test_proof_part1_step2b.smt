...
(assert (! (deleting w1 w2 x3 w3) :named Q22))
...
(assert (! (not (deleting w1 x1 w3 x2)) :named Q104))

(assert (! (not (intersection u1 v1 w1 w3)) :named Q111))
(assert (! (not (intersection u1 v1 w2 w3)) :named Q112))
(assert (! (not (intersection u1 v1 w1 x3)) :named Q113))
(assert (! (not (intersection u1 v1 w2 x3)) :named Q114))
