...
;w1w2 is deleted by w3x3
(assert (! (deleting w1 w2 w3 x3) :named Q21))
;(assert (! (intersection u1 v1 w2 w3) :named Q22))

;w2w3 is deleted by w4x4
(assert (! (deleting w2 w3 w4 x4) :named Q31))
;(assert (! (intersection u1 v1 w2 w4) :named Q32))


;there is no other edge deleting w1x1
(assert (! (not (deleting w1 x1 w3 x3)) :named Q101))
(assert (! (not (deleting w1 x1 x3 w3)) :named Q102))
(assert (! (not (deleting w1 x1 w3 x2)) :named Q103))
(assert (! (not (deleting w1 x1 x3 x2)) :named Q104))

;w3 and x3 are not inside a triangle formed by w1,x1,w2
(assert (! (not (inside w1 x1 w2 w3)) :named Q111))
(assert (! (not (inside w1 x1 w2 x3)) :named Q112))
(assert (! (not (inside w1 w2 x1 w3)) :named Q113))
(assert (! (not (inside w1 w2 x1 x3)) :named Q114))


;there is no other edge deleting w1w2
(assert (! (not (deleting w1 w2 w4 x4)) :named Q201))
(assert (! (not (deleting w1 w2 x4 w4)) :named Q202))
(assert (! (not (deleting w1 w2 w4 x3)) :named Q203))
(assert (! (not (deleting w1 w2 x4 x3)) :named Q204))


;w4 and x4 are not inside a triangle formed by w1,x1,w2 or w1,w2 and w3
(assert (! (not (inside w1 x1 w2 w4)) :named Q211))
(assert (! (not (inside w1 x1 w2 x4)) :named Q212))
(assert (! (not (inside w1 w2 x1 w4)) :named Q213))
(assert (! (not (inside w1 w2 x1 x4)) :named Q214))
(assert (! (not (inside w1 w2 w3 w4)) :named Q215))
(assert (! (not (inside w1 w2 w3 x4)) :named Q216))
(assert (! (not (inside w1 w3 w2 w4)) :named Q217))
(assert (! (not (inside w1 w3 w2 x4)) :named Q218))
