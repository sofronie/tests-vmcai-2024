...
(declare-fun triangle (point point point) Bool)
...
;used formula A1-6, B1-3 I1-6, I11-16, T1-4, E1-3, F1-5, R1, C1, D1-5, D11-14
...
(assert (! (forall ((u point) (v point) (w point)) (=> (and (left u v w) (left v u w)) (between u v w))) :named B1))   
(assert (! (forall ((u point) (v point) (w point)) (=> (between u v w) (left u v w))) :named B2))   
(assert (! (forall ((u point) (v point) (w point)) (=> (between u v w) (left v u w))) :named B3)) 

;definition of triangle(not colinear)
(assert (! (forall ((u point) (v point) (w point)) (=> (and (left u v w) (left v w u) (left w u v)) (triangle u v w))) :named B11))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle u v w) (left u v w))) :named B12))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle u v w) (left v w u))) :named B13))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle u v w) (left w u v))) :named B14))   
(assert (! (forall ((u point) (v point) (w point)) (=> (and (left v u w) (left w v u) (left u w v)) (triangle v u w))) :named B15))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle v u w) (left v u w))) :named B16))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle v u w) (left w v u))) :named B17))   
(assert (! (forall ((u point) (v point) (w point)) (=> (triangle v u w) (left u w v))) :named B18))   
...
(assert (! (not (triangle a b c)) :named Q1))
(assert (! (not (triangle b a c)) :named Q2))
(assert (! (not (between a b c)) :named Q3))
(assert (! (not (between a c b)) :named Q4))
(assert (! (not (between b c a)) :named Q5))
(assert (! (not (= a b)) :named Q6))
(assert (! (not (= b c)) :named Q7))
(assert (! (not (= c a)) :named Q8))
