...
;w1w3 is deleted by w4x4
(assert (! (deleting w1 w3 w4 x4) :named Q31))
;(assert (! (intersection u1 v1 w1 w4) :named Q32))
...
(assert (! (not (inside w1 x1 w2 w4)) :named Q201))
(assert (! (not (inside w1 x1 w2 x4)) :named Q202))
(assert (! (not (inside w1 w2 x1 w4)) :named Q203))
(assert (! (not (inside w1 w2 x1 x4)) :named Q204))

(assert (! (not (inside w1 w2 w3 w4)) :named Q211))
(assert (! (not (inside w1 w2 w3 x4)) :named Q212))
(assert (! (not (inside w1 w3 w2 w4)) :named Q213))
(assert (! (not (inside w1 w3 w2 x4)) :named Q214))

;there is no other edge deleting w1w2
(assert (! (not (deleting w1 w2 w4 x4)) :named Q301))
(assert (! (not (deleting w1 w2 x4 w4)) :named Q302))
(assert (! (not (deleting w1 w2 w4 x3)) :named Q303))
(assert (! (not (deleting w1 w2 x4 x3)) :named Q304))
