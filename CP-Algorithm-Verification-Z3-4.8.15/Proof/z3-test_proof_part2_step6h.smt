...
;(assert (! (intersection u1 v1 w1 w3) :named Q23))

;w4w4 is deleting w1w3
(assert (! (deleting w1 w3 w4 x4) :named Q31))
...
;there is no other edge deleting w1w3
(assert (! (not (deleting w1 w3 w5 x4)) :named Q121))
(assert (! (not (deleting w1 w3 w5 x5)) :named Q122))
(assert (! (not (deleting w1 w3 x4 w4)) :named Q123))
(assert (! (not (deleting w1 w3 x5 w5)) :named Q124))
(assert (! (not (deleting w1 w3 x5 x4)) :named Q125))
...
;w5 and x5 are not inside a triangle formed by w1,w3 and w4
(assert (! (not (inside w1 w3 w4 w5)) :named Q301))
(assert (! (not (inside w1 w3 w4 x5)) :named Q302))
(assert (! (not (inside w1 w4 w3 w5)) :named Q303))
(assert (! (not (inside w1 w4 w3 x5)) :named Q304))
