...
;w3x3 is deleting w2y and y is located inside w1x1w2
(assert (! (inside w1 x1 w2 y) :named Q21))
(assert (! (inside w1 x1 w2 z) :named Q22))
(assert (! (deleting z y w3 x3) :named Q23))
(assert (! (intersection w1 w3 w2 x2) :named Q24))

;w3x3 is not deleting w1w2 
...
(assert (! (not (deleting w1 x1 x2 w3)) :named Q104))
(assert (! (not (deleting w1 x1 x3 x2)) :named Q105))
(assert (! (not (deleting w1 x1 x2 x3)) :named Q106))

(assert (! (not (deleting w1 w2 w3 x3)) :named Q111))
(assert (! (not (deleting w1 w2 x3 w3)) :named Q112))


;(assert (! (not (inside w1 x1 w2 w3)) :named Q121))
;(assert (! (not (inside w1 x1 w2 x3)) :named Q122))

(assert (! (not (intersection w1 y w2 x2)) :named Q131))
(assert (! (not (intersection w1 z w2 x2)) :named Q132))
