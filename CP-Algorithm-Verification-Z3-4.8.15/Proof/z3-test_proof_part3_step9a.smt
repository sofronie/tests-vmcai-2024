...
;w3x3 is in F and deleting w2v1
(assert (! (deleting w2 v1 w3 x3) :named Q21))
(assert (! (F w3 x3) :named Q22))


;x1 is not inside u1v1w1
(assert (! (not (inside u1 v1 w1 x1)) :named Q101))

;w3 and x3 are not inside a triangle formed by u1,v1 and w1
(assert (! (not (deleting u1 v1 w3 x3)) :named Q111))
(assert (! (not (deleting u1 v1 x3 w3)) :named Q112))
(assert (! (not (deleting v1 w1 w3 x3)) :named Q113))
(assert (! (not (deleting v1 w1 x3 w3)) :named Q114))

;w3 and x3 are not inside a triangle formed by v1,w1 and w2
(assert (! (not (inside v1 w1 w2 w3)) :named Q121))
(assert (! (not (inside w1 v1 w2 w3)) :named Q122))
(assert (! (not (inside v1 w1 w2 x3)) :named Q123))
(assert (! (not (inside w1 v1 w2 x3)) :named Q124))
