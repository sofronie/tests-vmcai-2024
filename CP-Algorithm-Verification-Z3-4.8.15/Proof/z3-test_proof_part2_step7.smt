...
;x1w3 is deleting w1w2
(assert (! (deleting w1 w2 x1 w3) :named Q21))
;(assert (! (not (deleting w1 w2 w3 x1)) :named Q22))

;x2w2 is deleting w1x1
(assert (! (deleting w1 x1 x2 w2) :named Q31))
;(assert (! (intersection u1 v1 w1 x2) :named Q32))

;x1w4 is deleting w1x2
(assert (! (deleting w1 x2 x1 w4) :named Q41))
;(assert (! (not (deleting w1 x2 w4 x1)) :named Q42))
