...
;w2w3 is deleted by w1x4
(assert (! (deleting w2 w3 w1 x4) :named Q31))
;(assert (! (intersection u1 v1 w1 w2) :named Q32))
...
(assert (! (not (deleting w1 w2 x3 w3)) :named Q201))
(assert (! (not (deleting w1 w2 x4 x3)) :named Q202))
