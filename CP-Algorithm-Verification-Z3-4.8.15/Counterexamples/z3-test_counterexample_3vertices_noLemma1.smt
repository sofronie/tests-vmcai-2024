...
(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x v1) (= x y)))) :named Dom3))
...
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (deleting u v u1 v1) (deleting u v u1 y) (deleting u v v1 u1) (deleting u v v1 y) (deleting u v y u1) (deleting u v y v1)))) :named X1))
