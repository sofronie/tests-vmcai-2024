...
(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x u2) (= x u3) (= x v1) (= x v2) (= x y)))) :named Dom7))

; connected
(assert (! (forall ((u point) (v point)) (or (E u v) (and (E u u1) (E u1 v)) (and (E u u2) (E u2 v)) (and (E u u3) (E u3 v)) (and (E u v1) (E v1 v)) (and (E u v2) (E v2 v)) (and (E u y) (E y v)) 
...
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (and (intersection u v u1 u2) (F u1 u2)) (and (intersection u v u1 u3) (F u1 u3)) (and (intersection u v u1 v1) (F u1 v1)) (and (intersection u v u1 v2) (F u1 v2)) (and (intersection u v u1 y) (F u1 y))
(and (intersection u v u2 u3) (F u2 u3)) (and (intersection u v u2 v1) (F u2 v1)) (and (intersection u v u2 v2) (F u2 v2)) (and (intersection u v u2 y) (F u2 y))
(and (intersection u v u3 v1) (F u3 v1)) (and (intersection u v u3 v2) (F u3 v2)) (and (intersection u v u3 y) (F u3 y))
(and (intersection u v v1 v2) (F v1 v2)) (and (intersection u v v1 y) (F v1 y)) 
(and (intersection u v v2 y) (F v2 y))
))) :named X1))
