...
;assume we have connected graph with 3 vertices 
;such that after applying the algorithm
;one point is not connected to any of the other points.

; 3 elements

(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x v1) (= x y)))) :named Dom7))

; connected
(assert (! (forall ((u point) (v point)) (or (E u v) (and (E u u1) (E u1 v)) (and (E u v1) (E v1 v)) (and (E u y) (E y v)) 
(and (E u u1) (E u1 v1) (E v1 v)) (and (E u u1) (E u1 y) (E y v)) 
(and (E u v1) (E v1 u1) (E u1 v)) (and (E u v1) (E v1 y) (E y v))     
(and (E u y) (E y u1) (E u1 v)) (and (E u y) (E y v1) (E v1 v)) 
)) :named con))


;Every edge is in F or deleted by another edge
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (and (intersection u v u1 v1) (F u1 v1)) (and (intersection u v u1 y) (F u1 y))
