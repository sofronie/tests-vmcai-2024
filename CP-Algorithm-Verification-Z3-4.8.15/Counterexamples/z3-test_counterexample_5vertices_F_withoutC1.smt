...
;assume we have connected graph with 5 vertices 
;such that after applying the algorithm
;one point is not connected to any of the other points.

; 5 elements

(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x u2) (= x v1) (= x v2) (= x y)))) :named Dom7))
...
(and (E u u1) (E u1 u2) (E u2 v)) (and (E u u1) (E u1 v1) (E v1 v)) (and (E u u1) (E u1 v2) (E v2 v)) (and (E u u1) (E u1 y) (E y v)) 
(and (E u u2) (E u2 u1) (E u1 v)) (and (E u u2) (E u2 v1) (E v1 v)) (and (E u u2) (E u2 v2) (E v2 v)) (and (E u u2) (E u2 y) (E y v)) 
(and (E u v1) (E v1 u1) (E u1 v)) (and (E u v1) (E v1 u2) (E u2 v)) (and (E u v1) (E v1 v2) (E v2 v)) (and (E u v1) (E v1 y) (E y v)) 
(and (E u v2) (E v2 u1) (E u1 v)) (and (E u v2) (E v2 u2) (E u2 v)) (and (E u v2) (E v2 v1) (E v1 v)) (and (E u v2) (E v2 y) (E y v))  
(and (E u y) (E y u1) (E u1 v)) (and (E u y) (E y u2) (E u2 v))  (and (E u y) (E y v1) (E v1 v)) (and (E u y) (E y v2) (E v2 v))  
)) :named con))


;Every edge is in F or deleted by another edge
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (and (intersection u v u1 u2) (F u1 u2)) (and (intersection u v u1 v1) (F u1 v1)) (and (intersection u v u1 v2) (F u1 v2)) (and (intersection u v u1 y) (F u1 y))
(and (intersection u v u2 v1) (F u2 v1)) (and (intersection u v u2 v2) (F u2 v2)) (and (intersection u v u2 y) (F u2 y))
