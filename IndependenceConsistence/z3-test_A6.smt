...
(assert (! (inside a b c f) :named Q1))
(assert (! (left d e a) :named Q2))
(assert (! (left d e b) :named Q3))
(assert (! (left d e c) :named Q4))
(assert (! (not (left d e f)) :named Q5))
