...
(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x y)))) :named Dom2))

; connected
(assert (! (forall ((u point) (v point)) (or (E u v) (and (E u u1) (E u1 v)) (and (E u y) (E y v)) 
(and (E u u1) (E u1 y) (E y v))  
(and (E u y) (E y u1) (E u1 v)) 
)) :named con))


;Every edge is in F or deleted by another edge
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (deleting u v u1 y) (deleting u v y u1)))) :named X1))
