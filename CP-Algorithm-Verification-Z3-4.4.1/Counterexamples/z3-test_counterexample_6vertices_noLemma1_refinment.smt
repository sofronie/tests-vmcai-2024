...
;assume we have connected graph with 6 vertices 
;such that after applying the algorithm
;one point is not connected to any of the other points.

;6 elements

(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x u2) (= x u3) (= x v1) (= x v2)(= x y)))) :named Dom6))

; connected
(assert (! (forall ((u point) (v point)) (or (E u v) (and (E u u1) (E u1 v)) (and (E u u2) (E u2 v)) (and (E u v1) (E v1 v)) (and (E u v2) (E v2 v)) (and (E u y) (E y v)) 
(and (E u u1) (E u1 u2) (E u2 v)) (and (E u u1) (E u1 u3) (E u3 v)) (and (E u u1) (E u1 v1) (E v1 v)) (and (E u u1) (E u1 v2) (E v2 v)) (and (E u u1) (E u1 y) (E y v)) 
(and (E u u2) (E u2 u1) (E u1 v)) (and (E u u2) (E u2 u3) (E u3 v)) (and (E u u2) (E u2 v1) (E v1 v)) (and (E u u2) (E u2 v2) (E v2 v)) (and (E u u2) (E u2 y) (E y v)) 
(and (E u u3) (E u3 u1) (E u1 v)) (and (E u u3) (E u3 u2) (E u2 v)) (and (E u u3) (E u3 v1) (E v1 v)) (and (E u u3) (E u3 v2) (E v2 v)) (and (E u u3) (E u3 y) (E y v)) 
(and (E u v1) (E v1 u1) (E u1 v)) (and (E u v1) (E v1 u2) (E u2 v)) (and (E u v1) (E v1 u3) (E u3 v)) (and (E u v1) (E v1 v2) (E v2 v)) (and (E u v1) (E v1 y) (E y v)) 
(and (E u v2) (E v2 u1) (E u1 v)) (and (E u v2) (E v2 u2) (E u2 v)) (and (E u v2) (E v2 u3) (E u3 v)) (and (E u v2) (E v2 v1) (E v1 v)) (and (E u v2) (E v2 y) (E y v)) 
(and (E u y) (E y u1) (E u1 v)) (and (E u y) (E y u2) (E u2 v)) (and (E u y) (E y u3) (E u3 v)) (and (E u y) (E y v1) (E v1 v)) (and (E u y) (E y v2) (E v2 v)) 
)) :named con))


;Every edge is in F or deleted by another edge
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (deleting u v u1 u2) (deleting u v u1 u3) (deleting u v u1 v1) (deleting u v u1 v2) (deleting u v u1 y) (deleting u v u2 u1) (deleting u v u2 u3) (deleting u v u2 v1) (deleting u v u2 v2) (deleting u v u2 y) (deleting u v u3 u1) (deleting u v u3 u2) (deleting u v u3 v1) (deleting u v u3 v2) (deleting u v u3 y) (deleting u v v1 u1) (deleting u v v1 u2) (deleting u v v1 u3) (deleting u v v1 v2) (deleting u v v1 y) (deleting u v v2 u1) (deleting u v v2 u2) (deleting u v v2 u3) (deleting u v v2 u1) (deleting u v v2 u2) (deleting u v v2 u3) (deleting u v v2 v1) (deleting u v v2 y) (deleting u v y u1) (deleting u v y u2) (deleting u v y u3) (deleting u v y v1) (deleting u v y v2)))) :named X1))

;no collinear vertices
(assert (! (forall ((u point) (v point) (w point)) (=> (and (left u v w) (left v u w)) (not (E u v)))) :named ref))  
