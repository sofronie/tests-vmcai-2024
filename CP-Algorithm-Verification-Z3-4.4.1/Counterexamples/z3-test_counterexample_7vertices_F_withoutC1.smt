...
;(assert (! (forall ((u point) (v point) (w point) (x point)) (=> (and (E u v) (E v w) (E w u) (V x) (inside u v w x )) (or (E u x) (E v x)))) :named C2))
...
;assume we have connected graph with 7 vertices 
;such that after applying the algorithm
;one point is not connected to any of the other points.

; 7 elements

(assert (! (forall ((x point)) (=> (V x) (or (= x u1) (= x u2) (= x u3) (= x v1) (= x v2) (= x v3) (= x y)))) :named Dom7))

; connected
(assert (! (forall ((u point) (v point)) (or (E u v) (and (E u u1) (E u1 v)) (and (E u u2) (E u2 v)) (and (E u u3) (E u3 v)) (and (E u v1) (E v1 v)) (and (E u v2) (E v2 v)) (and (E u v3) (E v3 v)) (and (E u y) (E y v)) 
(and (E u u1) (E u1 u2) (E u2 v)) (and (E u u1) (E u1 u3) (E u3 v)) (and (E u u1) (E u1 v1) (E v1 v)) (and (E u u1) (E u1 v2) (E v2 v)) (and (E u u1) (E u1 v3) (E v3 v)) (and (E u u1) (E u1 y) (E y v)) 
(and (E u u2) (E u2 u1) (E u1 v)) (and (E u u2) (E u2 u3) (E u3 v)) (and (E u u2) (E u2 v1) (E v1 v)) (and (E u u2) (E u2 v2) (E v2 v)) (and (E u u2) (E u2 v3) (E v3 v)) (and (E u u2) (E u2 y) (E y v)) 
(and (E u u3) (E u3 u1) (E u1 v)) (and (E u u3) (E u3 u2) (E u2 v)) (and (E u u3) (E u3 v1) (E v1 v)) (and (E u u3) (E u3 v2) (E v2 v)) (and (E u u3) (E u3 v3) (E v3 v)) (and (E u u3) (E u3 y) (E y v)) 
(and (E u v1) (E v1 u1) (E u1 v)) (and (E u v1) (E v1 u2) (E u2 v)) (and (E u v1) (E v1 u3) (E u3 v)) (and (E u v1) (E v1 v2) (E v2 v)) (and (E u v1) (E v1 v3) (E v3 v)) (and (E u v1) (E v1 y) (E y v)) 
(and (E u v2) (E v2 u1) (E u1 v)) (and (E u v2) (E v2 u2) (E u2 v)) (and (E u v2) (E v2 u3) (E u3 v)) (and (E u v2) (E v2 v1) (E v1 v)) (and (E u v2) (E v2 v3) (E v3 v)) (and (E u v2) (E v2 y) (E y v)) 
(and (E u v3) (E v3 u1) (E u1 v)) (and (E u v3) (E v3 u2) (E u2 v)) (and (E u v3) (E v3 u3) (E u3 v)) (and (E u v3) (E v3 v1) (E v1 v)) (and (E u v3) (E v3 v2) (E v2 v)) (and (E u v3) (E v3 y) (E y v)) 
(and (E u y) (E y u1) (E u1 v)) (and (E u y) (E y u2) (E u2 v)) (and (E u y) (E y u3) (E u3 v)) (and (E u y) (E y v1) (E v1 v)) (and (E u y) (E y v2) (E v2 v)) (and (E u y) (E y v3) (E v3 v)) 
)) :named con))


;Every edge is in F or deleted by another edge
(assert (! (forall ((u point) (v point)) (=> (E u v) (or (F u v) (and (intersection u v u1 u2) (F u1 u2)) (and (intersection u v u1 u3) (F u1 u3)) (and (intersection u v u1 v1) (F u1 v1)) (and (intersection u v u1 v2) (F u1 v2)) (and (intersection u v u1 v3) (F u1 v3)) (and (intersection u v u1 y) (F u1 y))
(and (intersection u v u2 u3) (F u2 u3)) (and (intersection u v u2 v1) (F u2 v1)) (and (intersection u v u2 v2) (F u2 v2)) (and (intersection u v u2 v3) (F u2 v3)) (and (intersection u v u2 y) (F u2 y))
(and (intersection u v u3 v1) (F u3 v1)) (and (intersection u v u3 v2) (F u3 v2)) (and (intersection u v u3 v3) (F u3 v3)) (and (intersection u v u3 y) (F u3 y))
(and (intersection u v v1 v2) (F v1 v2)) (and (intersection u v v1 v3) (F v1 v3)) (and (intersection u v v1 y) (F v1 y)) 
(and (intersection u v v2 v3) (F v2 v3)) (and (intersection u v v2 y) (F v2 y))
(and (intersection u v v3 y) (F v3 y))
))) :named X1))
...
;(assert (! (deleting u1 y u3 v3) :named Q3))


(assert (! (not (F v1 y)) :named Q101))
(assert (! (not (F v2 y)) :named Q102))
(assert (! (not (F v3 y)) :named Q103))
(assert (! (not (F u1 y)) :named Q104))
(assert (! (not (F u2 y)) :named Q105))
(assert (! (not (F u3 y)) :named Q106))

(assert (! (not (= u1 u2)) :named Q201))
(assert (! (not (= u1 u3)) :named Q202))
(assert (! (not (= u1 v1)) :named Q203))
(assert (! (not (= u1 v2)) :named Q204))
(assert (! (not (= u1 v3)) :named Q205))
(assert (! (not (= u1 y)) :named Q206))

(assert (! (not (= u2 u3)) :named Q212))
(assert (! (not (= u2 v1)) :named Q213))
(assert (! (not (= u2 v2)) :named Q214))
(assert (! (not (= u2 v3)) :named Q215))
(assert (! (not (= u2 y)) :named Q216))

(assert (! (not (= u3 v1)) :named Q223))
(assert (! (not (= u3 v2)) :named Q224))
(assert (! (not (= u3 v3)) :named Q225))
(assert (! (not (= u3 y)) :named Q226))

(assert (! (not (= v1 v2)) :named Q234))
(assert (! (not (= v1 v3)) :named Q235))
(assert (! (not (= v1 y)) :named Q236))

(assert (! (not (= v2 v3)) :named Q245))
(assert (! (not (= v2 y)) :named Q246))

(assert (! (not (= v3 y)) :named Q256))
