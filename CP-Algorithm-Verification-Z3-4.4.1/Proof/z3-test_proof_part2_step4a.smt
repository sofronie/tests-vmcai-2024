...
(assert (! (deleting w1 w2 x1 x3) :named Q21))
;(assert (! (intersection w1 x1 w3 x3) :named Q22))



(assert (! (not (deleting w1 x1 x2 w2)) :named Q101))
(assert (! (not (deleting w1 x1 x3 x2)) :named Q102))
